...
export default function Home() {
  return (
    <div className="pt-[72px] min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col transition-colors duration-300">
      
      {/* Floating Background Icons */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0 opacity-[0.12] dark:opacity-[0.25] transition-opacity duration-500">
